...
/**
 * @file
 * Contains \Drupal\crab_file_field_path\Form\SettingsForm.
 */

namespace Drupal\crab_file_field_path\Form;
...
/**
 * Administration settings form for Crab File Field Path.
 *
 * @package Drupal\crab_file_field_path\Form
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'crab_file_field_path_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL) {
    $form['temp_location'] = array(
      ...
      '#type'          => 'textfield',
      '#default_value' => $this->config('crab_file_field_path.settings')
        ->get('temp_location'),
      '#description'   => t('The location that unprocessed files will be uploaded priot to being processed by Crab File Field Path.<br />It is recommended that you use the temporary file system (temporary://) if your server configuration allows for that.'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $values = $form_state->getValues();
    $this->config('crab_file_field_path.settings')
