...
/**
 * @file
 * Hooks provided by the Crab File (Field) Path module.
 */

/**
 * Define field(s) to be displayed on the Crab File (Field) Path settings form and
 * used during the processing of uploaded files.
 *
 * @param $field
 *   The field definition this Crab File (Field) Path settings field applies to.
 * @param $instance
 *   The field instance this Crab File (Field) Path settings field applies to.
 *
 * @return array
 ...
 *
 * @see hook_crab_file_field_path_process_file()
 */
function hook_crab_file_field_path_field_settings($field, $instance) {
  return array(
    'file_path' => array(
      'title' => 'File path',
      'form'  => array(
...
/**
 * Declare a compatible field type for use with Crab File (Field) Path.
 *
 * @return array
 *   An array of field types.
 */
function hook_crab_file_field_path_field_type_info() {
  return array('file');
}
 ...
 *
 * @see crab_file_field_path_crab_file_field_path_process_file().
 */
function hook_crab_file_field_path_process_file($type, $entity, $field, $instance, $langcode, &$items) {
}